...
const file_login_proto_rawDesc = "" +
	"\n" +
	"\vlogin.proto\x12\x04user\"E\n" +
	"\x11UsersLoginRequest\x12\x14\n" +
	"\x05email\x18\x01 \x01(\tR\x05email\x12\x1a\n" +
	"\bpassword\x18\x02 \x01(\tR\bpasswordB9Z7https://github.com/grozaqueen/julse/api/protos/user/genb\x06proto3"
